...
/*
    Функционал плагина:
        Предназначен для наполнения сайта следующим образом:
            получает массив из файла json
            создаёт записи типа "post" (или указанного типа (???))  при этом:
                указывает таксономию к кторым относиться запись
                прикрепляет постера 
